# Pai$@ Management - Personal Expense Tracker
...
- **Dashboard**: 
  ...
  - Category-wise expense visualization (Bar & Pie charts)
...
- **Profile**:
  ...
  - Starting Balance updates (for promotions/major changes)
...
- **Actions per user**:
  - 👁️ View: Open user's full account (transactions, commitments, stats)
  - ✏️ Edit: Modify name, email, role
...
- All currency displayed in Indian Rupees (₹)
